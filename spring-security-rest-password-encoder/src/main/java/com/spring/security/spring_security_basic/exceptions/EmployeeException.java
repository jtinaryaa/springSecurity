...
public class EmployeeException extends RuntimeException {
    ...
    public ResponseEntity<ApiResponse> handlerUsernameNotFoundException(UsernameNotFoundException usernameNotFoundException) {
        ApiResponse error = ApiResponse.builder()
                .message(usernameNotFoundException.getMessage())
                .errorCode("Username not found")
                .errorDescription(usernameNotFoundException.getCause())
